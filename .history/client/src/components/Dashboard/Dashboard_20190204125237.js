...
const propTypes = {
    ...
    onEventAlert : PropTypes.func.isRequired
};
    ...
    return (
        <div className={styles.dashWrapper}>
            ...
            <Modal offset={windowOffset} show={showSetsModal} modalClosed={modalCancelHandler}>
                {activeSets ?
                    <ArtistSetsMap onAlert={onEventAlert} lat={location.latitude} lon={location.longitude} sets={activeSets} artist={activeSetsArtist}/> :
                    null}
            </Modal>
