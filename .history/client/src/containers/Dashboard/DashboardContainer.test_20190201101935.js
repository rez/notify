...
describe('Private Route HOC', () => {
    ...
    it('handle artist release clicked', () => {
       ...
       console.log(Object.keys(wrapper.state()).reduce((acc,obj) =>{acc[obj.key] = obj.valueOf; return acc}, []));
       expect(Object.keys(wrapper.state()).reduce((acc,obj) =>{acc[obj.key] = obj.valueOf; return acc}, []).includes({activeReleases : fixtures.releases[0].releases, 
